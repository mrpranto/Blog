...
<head>
    ...
    <title>Floral a Blogging Category Flat Bootstrap Responsive Website Template | Home :: w3layouts</title>
        ...
        <div class="content-text">
            ...
            <div class="title">
                <div class="some-title">
                    <h3><a href="single.html">Some Title Goes Here</a></h3>
                </div>
                <div class="john">
                ...
                <div class="tilte-grid">
                    <a href="single.html"><img src="{{ asset('frontend/images/1.jpg') }}" alt=" " /></a>
                ...
                <div class="tilte-grid">
                    <a href="single.html"><img src="{{ asset('frontend/images/2.jpg') }}" alt=" " /></a>
                    <p class="vel"><a href="single.html">Phasellus vel arcu vitae neque sagittis aliquet ac at purus.
                            Vestibulum varius eros in dui sagittis non ultrices orci hendrerit.
...
<div class="footer-bottom">
    <div class="container">
        <p>© 2015 Floral. All rights Reserved | Template by<a href="http://w3layouts.com/"> w3layouts</a></p>
    </div>
</div>
<!-- //footer -->
